...
func _initialize() -> void:
	...
	_expect(main.battle_board.unit_sigil_glyph(marked_unit).canonical_serialization() == MeaningGlyphsModel.glyph(MeaningGlyphsModel.STAR).canonical_serialization(), "battle units should retain the exact meaning sigil that produced their combat variant")

...
func _initialize() -> void:
	...
	_expect(main._first_production_tick(main.factory_board.plan_production_snapshot(MvpContent.PLAN_STELLAR)) > 0, "plan comparison should derive first arrival from the cached non-destructive forecast")

...
func _initialize() -> void:
	...
	_expect("魔力 40/100" in scout_plan_tooltip.context and "/32秒" in scout_plan_tooltip.context, "template hover should compare its current-run mana and production without applying it")

...
- 赤・青・緑の3属性、各8文字、合計24種類のルーン素材
- 3×3盤の中央を除く8位置に基づく、予測可能な上下左右移動
- 中央・盤外へ移動したルーンだけが消滅する一括加工
- 属性変換、抽出、最大8文字の合成（同じルーンの重複を保持）
...
完成ターゲットから必要なルーンを読み取れ、移動・属性変換・抽出・合成の結果を実行前に予測できることを最優先にします。そのうえで、素材源の距離、搬送時間、一括加工、分岐と再合流に複数の工場解を残します。
